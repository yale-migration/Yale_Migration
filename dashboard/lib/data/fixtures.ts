...
export const DEMO_ENQUIRIES: Enquiry[] = [
  { id:1, enquiry_date:'2026-08-19', name:'Priya R.', phone:'0400 111 222', email:'priya@example.com',
    channel:'Facebook', visa_interest:'500', office:'BRISBANE', location:'Onshore', assigned_to:'Rey',
  ...
  { id:2, enquiry_date:'2026-08-18', name:'Chen W.', phone:'0400 333 444', email:'chen@example.com',
    channel:'Website', visa_interest:'485', office:'BRISBANE', location:'Offshore', assigned_to:'RJ',
  ...
  { id:3, enquiry_date:'2026-08-16', name:'Amara O.', phone:'0400 555 666', email:null,
    channel:'WhatsApp', visa_interest:'482', office:'TOWNSVILLE', location:'Onshore', assigned_to:'Star',
  ...
  { id:4, enquiry_date:'2026-08-15', name:null, phone:'0400 777 888', email:null,
    channel:'Phone', visa_interest:null, office:'BRISBANE', location:'Offshore', assigned_to:null,
  ...
  { id:5, enquiry_date:'2026-08-11', name:'Sofia M.', phone:'0400 999 000', email:'sofia@example.com',
    channel:'Referral', visa_interest:'189', office:'BRISBANE', location:'Onshore', assigned_to:'Priyanka',
  ...
  { id:6, enquiry_date:'2026-07-17', name:'Ken T.', phone:'0401 222 333', email:'ken@example.com',
    channel:'Instagram', visa_interest:'600', office:'TOWNSVILLE', location:'Offshore', assigned_to:'Cristelle',
