...
CR-003 | 2026-07-25 | (internal note) Personal OneDrive = 5GB cap + client passports on one personal
account | PARKED | Phase 2/3 recommendation: business storage upgrade or migrate folders to Google
Drive (would simplify the stack).
