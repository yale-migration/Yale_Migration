...
`DECISIONS.md` is 728K /    10323 lines. **Do not read it whole — it will eat the session.**
Find the D-number here, then `grep -A 25 "^D-NNN" DECISIONS.md` (or `^## D-NNN`) for that entry only.

Regenerate: `bash scripts/gen_decisions_index.sh`  ·  Generated 2026-09-14 16:31
