...
| **A-21** | 🔴 **Who is the consultant for each client?** Their tracker has **no consultant and no branch column** (D-303) | 14 Aug | 🔴 **kills "branch performance" and "workload per consultant"** — the view he has asked for four times |
