...
| **A-20** | 🔴 **Share both Google Sheets with `project1@` (Viewer)** — we hold static exports, not live data (D-304) | 14 Aug · **re-sent 16 Aug as Q9** | 🔴 **one click.** Without it the dashboard reads a snapshot that is already stale |
...
| **A-26** | **Two small fee questions + one document question** — (1) the 500 DHA charge reads **$2,000** on the quote page but **$2,500** in the fee master's IMMI column, which is current? (2) the fee master files **$430** under *Professional Fee* for 407, but their own 407 checklist shows $430 as the **visa application charge** and $2,200 as the professional fee — looks like a column slip. (3) `500_ADDING-DEPENDENT.pdf` page 3 is a quote page carrying Yale's **BSB / account / SWIFT** and a hard-coded **$2,028 dated 17/10/2025** — M4 copies that file to every 500-adding-dependent client. Should that page ship, or be split out? | 🟢 **not blocking.** Raise at the next natural message (G5). Their document, their RMA's call — we do not change it |
